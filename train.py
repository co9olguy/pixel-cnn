...
parser.add_argument('-d', '--data_set', type=str, default='mnist', help='Can be either cifar|imagenet|mnist')
...
DataLoader = {'cifar':cifar10_data.DataLoader, 'imagenet':imagenet_data.DataLoader, 'mnist':mnist_data.DataLoader}[args.data_set]
